...
<html>
	<head>
		...
		<link rel="stylesheet" href="css/indexzn.css">
		<link rel="stylesheet" href="css/indexxz.css">
			...
			<div id="top">
				...
				<div id="navigation">
					<ul>
						...
						<li><a href="#">业务平台</a></li>
						<li><a href="indexzn.php">职能概况</a></li>
						<li><a href="indexgz.php">工作动态</a></li>
						<li><a href="indexzd.php">制度规范</a></li>
						<li><a href="indexzs.php">知识库</a></li>
						<li><a href="indexxz.php"  class="tru">下载专区</a></li>
					</ul>
				</div>
			</div>
			<div id="find">
				<div id="find1">
					<span>资料名称：</span><input type="text" class="textzl"/><span>资料类型：</span><input type="text"/><span>上传作者：</span><input type="text"/>-<input type="text" placeholder="选择日期"/><input type="button" value="搜索" class="bt"/><input type="button" value="重置" class="cz"/>
				</div>
			</div>
			<div id="textbox">
				<div id="left">
					<ul>
						<li><span><img src="img/1A.png"></span><a href="#" class="def zn1">培训资料</a></li>
						<li><span><img src="img/2A.png"></span><a href="#" class="zn2">软件工具</a></li>
						<li><span><img src="img/3A.png"></span><a href="#" class="zn2">其他资料</a></li>
				</div>
				<div id="mains">
					<div class="zhize ma1">
					<h3>下载专区</h3>
