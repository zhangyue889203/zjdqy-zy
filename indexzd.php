	...
	<body>
		...
		<div id="container">
			<div id="top">
				...
				<div id="navigation">
					<ul>
						...
						<li><a href="indexzd.php"  class="tru">制度规范</a></li>
			...
			<div id="textbox">
				<div id="left">
					<ul>
						<li><span><img src="img/1A.png"></span><a href="#" class="def zn1">制度规范</a></li>
						<li><span><img src="img/2A.png"></span><a href="#" class="zn2">绩效考核</a></li>
						<li><span><img src="img/3A.png"></span><a href="#" class="zn2">年度计划</a></li>
				</div>
				<div id="mains">
					<div class="zhize ma1">
					<h3>制度规范</h3>
		...
		<?php }else{echo '<script>location.href="login.html"</script>';} ?>
	</body>
</html>
