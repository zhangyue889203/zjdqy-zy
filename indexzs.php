	...
	<body>
		...
		<div id="container">
			<div id="top">
				...
				<div id="navigation">
					<ul>
						...
						<li><a href="indexzs.php"  class="tru">知识库</a></li>
			...
			<div id="textbox">
				<div id="left">
					<ul>
						<li><span><img src="img/1A.png"></span><a href="#" class="def zn1">分析指引</a></li>
						<li><span><img src="img/2A.png"></span><a href="#" class="zn2">税证辑要</a></li>
						<li><span><img src="img/3A.png"></span><a href="#" class="zn2">案例库</a></li>
				</div>
				<div id="mains">
					<div class="zhize ma1">
					<h3>知识库</h3>
